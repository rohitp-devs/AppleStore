...
{
$did=$_GET['deleteid'];
$q= mysqli_query($conn,"delete from customer where cust_id='{$did}'");
if($q)
{
                  ...
                  <tr>
                      ...
                      <th>Action</th>
                          ...
                          <?php
                                      ...
                                      {
                                          echo "<tr>";
                                          echo "<td>".$a['cust_id']."</td>";
                                          echo "<td>".$a['cust_name']."</td>";
                                          echo "<td>".$a['cust_email']."</td>";
                                          echo "<td>".$a['cust_pass']."</td>";
                                          echo "<td>".$a['cust_mobile']."</td>";
                                          echo "<td><a href='?deleteid={$a['cust_id']}'>Delete</a></td>";
